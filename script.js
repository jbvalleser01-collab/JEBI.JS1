...
"btn5".addEventListener("click", () => {
    ...
    trAverage.style.height = "30px";

    tdAverageLabel.style.fontWeight = "bold";
    tdAverageLabel.innerHTML = "AVERAGE";
    tdAverageValue.style.textDecoration = "underline";

    if(numbersArr.length == 0) {
        tdAverageValue.innerHTML = "N/A";
    } else {
        tdAverageValue.innerHTML = (total / numbersArr.length).toFixed(2);
    }
